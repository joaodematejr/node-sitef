...
protected:
  ...
  {
    result = configuraIntSiTefInterativo(ip.c_str(), loja.c_str(), terminal.c_str(), reservado.c_str(), parametrosAdicionais.c_str());
  }
...
private:
  ConfigPromise(napi_env env, string &p_ip, string &p_loja, string &p_terminal, string &p_reservado, string &p_parametrosAdicionais) : PromiseWorker(env),
                                                                                                       ip(p_ip),
                                                                                                       loja(p_loja),
                                                                                                       terminal(p_terminal),
